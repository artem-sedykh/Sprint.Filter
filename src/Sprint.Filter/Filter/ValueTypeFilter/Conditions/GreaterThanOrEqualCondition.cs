...
// ReSharper restore CheckNamespace
{
    ...
    public sealed class GreaterThanOrEqualCondition<TProperty> : IValueTypeCondition<TProperty> where TProperty : struct, IComparable, IComparable<TProperty>, IEquatable<TProperty>
    {
        public GreaterThanOrEqualCondition() { }

        public GreaterThanOrEqualCondition(string title)
        {
            Title = title;
        }
        ...
        public Expression<Func<TModel, bool>> For<TModel>(Expression<Func<TModel, TProperty?>> property)
        {
            ...
            return Expression.Lambda<Func<TModel, bool>>(Expression.GreaterThanOrEqual(property.Body, val), property.Parameters[0]);
        }
