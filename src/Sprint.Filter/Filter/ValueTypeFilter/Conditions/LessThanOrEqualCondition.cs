...
// ReSharper restore CheckNamespace
{
    ...
    public sealed class LessThanOrEqualCondition<TProperty> : IValueTypeCondition<TProperty> where TProperty : struct, IComparable, IComparable<TProperty>, IEquatable<TProperty>
    {
        public LessThanOrEqualCondition() { }

        public LessThanOrEqualCondition(string title)
        {
            Title = title;
        }
        ...
        public Expression<Func<TModel, bool>> For<TModel>(Expression<Func<TModel, TProperty?>> property)
        {
            ...
            return Expression.Lambda<Func<TModel, bool>>(Expression.LessThanOrEqual(property.Body, val), property.Parameters[0]);
        }
