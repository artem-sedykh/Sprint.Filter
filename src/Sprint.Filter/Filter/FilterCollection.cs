namespace Sprint.Filter
{
    ...
    public class FilterCollection : IFilterCollection
    {
        ...
        public IFilterCollection Init(IFilterOptions options)
        {
            ...
            if (_filtersOptions?.Filters != null)
            {
        ...
        public IFilter this[string key] => _filters[key];


        /// <summary>
        /// Filters.
        /// </summary>
        public IDictionary<string, IFilter> Filters => _filters;
        ...
        /// </summary>
        public IFilterOptions FilterOptions => _filtersOptions;
    }
}
