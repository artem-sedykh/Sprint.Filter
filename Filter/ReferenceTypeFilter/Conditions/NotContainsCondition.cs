...
// ReSharper restore CheckNamespace
{
    ...
    public sealed class NotContainsCondition : IReferenceTypeCondition<string>
    {
        private readonly string _title;

        public NotContainsCondition() { }

        public NotContainsCondition(string title)
        {
            _title = title;
        }
        ...
        public Expression<Func<TModel, bool>> For<TModel>(Expression<Func<TModel, string>> property)
        {
            ...
            return Expression.Lambda<Func<TModel, bool>>(Expression.Not(containsMethodExp), property.Parameters[0]);
        }
