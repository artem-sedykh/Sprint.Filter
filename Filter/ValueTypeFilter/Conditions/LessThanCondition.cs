...
// ReSharper restore CheckNamespace
{
    ...
    public sealed class LessThanCondition<TProperty> : IValueTypeCondition<TProperty> where TProperty : struct, IComparable, IComparable<TProperty>, IEquatable<TProperty>
    {
        private readonly string _title;

        public LessThanCondition() { }

        public LessThanCondition(string title)
        {
            _title = title;
        }
        ...
        public Expression<Func<TModel, bool>> For<TModel>(Expression<Func<TModel, TProperty?>> property)
        {
            ...
            return Expression.Lambda<Func<TModel, bool>>(Expression.LessThan(property.Body, val), property.Parameters[0]);
        }
