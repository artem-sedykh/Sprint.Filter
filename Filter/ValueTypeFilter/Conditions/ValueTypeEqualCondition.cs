...
// ReSharper restore CheckNamespace
{
    ...
    public sealed class ValueTypeEqualCondition<TProperty> : IValueTypeCondition<TProperty> where TProperty : struct, IComparable, IComparable<TProperty>, IEquatable<TProperty>
    {
        private readonly string _title;

        public ValueTypeEqualCondition() { }

        public ValueTypeEqualCondition(string title)
        {
            _title = title;
        }
